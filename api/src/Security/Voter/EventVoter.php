...
final class EventVoter extends Voter
{
    ...
    protected function supports(string $attribute, mixed $subject): bool
    {
        ...
        return in_array($attribute, [self::EDIT, self::VIEW, self::CSV])
    ...
    protected function voteOnAttribute(string $attribute, mixed $subject, TokenInterface $token): bool
    {
        ...
        return match ($attribute) {
            ...
            self::CSV => self::canCSV($user, $subject),
            default => false,
        };
    }
    ...
    public static function canCSV(UserInterface $user, \App\Entity\Event $subject): bool
    {
        // conditions for viewing:
        // - the user must be a part of the event
        // - the user must be part of the event admins
